...
class TFNet(object):
    ...
    def __init__(self, FLAGS, darknet = None):
        ...
        if self.FLAGS.savedModelLoad:
            ...
            return
        elif self.FLAGS.pbLoad and self.FLAGS.metaLoad:
    ...
    def build_from_saved_model(self):
        ...
        tf.saved_model.loader.load(
            ...
            self.FLAGS.savedModelLoad)
        self.inp = self.sess.graph.get_tensor_by_name('input:0')
        self.out = self.sess.graph.get_tensor_by_name('output:0')

        darknet = Darknet(self.FLAGS)
        self.darknet = darknet
        args = [darknet.meta, self.FLAGS]
        self.framework = create_framework(*args)
    ...
    def setup_meta_ops(self):
        ...
        if self.FLAGS.summary:
            ...
            self.writer = tf.summary.FileWriter(self.FLAGS.summary)
